class Thing {
	...
	Thing({this.label, this.bridgeUID, this.configuration, this.properties, this.uID, this.thingTypeUID, this.channels, this.location});
	...
	Thing.fromJson(Map<String, dynamic> json) {
		...
		properties = json['properties'] != null ? Configuration.fromJson(json['properties']) : null;
		uID = json['UID'];
		thingTypeUID = json['thingTypeUID'];
		if (json['channels'] != null) {
			channels = <Channels>[];
			json['channels'].forEach((v) { channels!.add(Channels.fromJson(v)); });
		}
...
class Channels {
	...
	Channels({this.uid, this.id, this.channelTypeUID, this.itemType, this.kind, this.label, this.description, this.defaultTags, this.properties, this.configuration});
