        ...
        child: Padding(
          ...
          child: ListView.builder(
            itemBuilder: ((context, index) => GestureDetector(
              onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: ((context) => RoomsDetailsPage(title: 'Room ${index + 1}',)))),
              child: Container(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text('Room ${index + 1}', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 25),),
                            ],
                          ),
                          const Spacer(flex: 1,),
                        ],
